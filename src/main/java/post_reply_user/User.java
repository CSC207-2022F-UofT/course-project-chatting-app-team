...
public abstract class User {
    ...
    static class random_User extends User{
        ...
        ArrayList<post_reply_user.Post> All_Post;
        ...
        public void setAll_Post(random_User user_4) {
            ArrayList<post_reply_user.Post> lst = null;
        ...
        public ArrayList<post_reply_user.Post> get_All_Post(random_User user_4){
        ...
        public void delete_Post(post_reply_user.Post post){
